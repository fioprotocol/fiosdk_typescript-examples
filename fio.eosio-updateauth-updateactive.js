...
const privateKey = properties.privateKey,
  ...
  permissionName = 'active',  // The permission being updated (e.g. 'active' or 'owner')
  parent = 'owner',     // Parent of the permission (e.g. 'active' or 'owner'. Use '' when updating the owner permission.)
      ...
      data: {
        ...
        "auth": {
          ...
          "accounts": [
            {
              "permission": {
                "actor": account,        // To keep the existing account
            ...
            {
              "permission": {
                "actor": additionalAccount,  // To add the new account
                "permission": permission
              },
              "weight": 1
            }
